...
Begin VB.Form frmRNoticeOfChange 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmRNoticeOfChange"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("Notice of Change Form Criteria", Me) Then Exit Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "Notice of Change form(s) generated successfully.", vbOKOnly + vbInformation, "Notice of Change Form"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "Notice of Change Form"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating Notice of Change form.", vbOKOnly + vbCritical, "Notice of Change Form"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "Notice of Change Form", "Select")
    Cri_SetAll = False
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "Notice of Change Form", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRNoticeOfChange = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    SQLQ = "SELECT ED_EMPNBR, ED_FNAME, ED_SURNAME, ED_DEPTNO, ED_DIV, ED_ORG, ED_EMP, "
    SQLQ = SQLQ & " SH_JOB, SH_SALARY FROM HREMP, HR_SALARY_HISTORY,HR_JOB_HISTORY "
    SQLQ = SQLQ & " WHERE (ED_EMPNBR = SH_EMPNBR AND SH_CURRENT <>0) AND (ED_EMPNBR = JH_EMPNBR AND JH_CURRENT <>0)"
    If Len(glbstrSelCri) > 0 Then
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "Notice of Change Form.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "NOF_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
                ...
                If gSec_Inq_Salary Then
                    .ActiveDocument.FormFields("dblSalary").Result = rsEmp("SH_SALARY")
                End If
                .ActiveDocument.FormFields("txtStatus").Result = GetTABLDesc("EDEM", rsEmp("ED_EMP"))
                .ActiveDocument.FormFields("txtDeptDiv").Result = GetDeptName(rsEmp("ED_DEPTNO"), "DF_NAME") & "/" & Get_Division_Name(rsEmp("ED_DIV"))
                .ActiveDocument.FormFields("txtPosition").Result = GetJobCodeDesc(rsEmp("SH_JOB"))
                .ActiveDocument.FormFields("txtShift").Result = GetTABLDesc("EDOR", rsEmp("ED_ORG"))
                '.ActiveDocument.FormFields("txtAAAAccessType").Result = They will manually update this field.
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "IT Notice of Change Form", "IT Notice of Change Form", "Generate Word Form")
