...
Begin VB.Form frmRPerfImprovActPlan 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmRPerfImprovActPlan"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("Performance Improvement Action Plan Criteria", Me) Then Exit Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "Performance Improvement Action Plan form(s) generated successfully.", vbOKOnly + vbInformation, "Performance Improvement Action Plan"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "Performance Improvement Action Plan"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating Performance Improvement Action Plan form.", vbOKOnly + vbCritical, "Performance Improvement Action Plan"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "Performance Improvement Action Plan", "Select")
    Cri_SetAll = False
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "Performance Improvement Action Plan", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRPerfImprovActPlan = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "Performance Improvement Action Plan.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "PIAP_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Word Forms", "Performance Improvement Action Plan", "Generate Word Form")
