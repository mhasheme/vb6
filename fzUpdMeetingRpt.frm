...
Begin VB.Form frmRUpdMeetingRpt 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   Caption         =   "Update Meeting"
   ClientHeight    =   10950
   ClientLeft      =   435
   ClientTop       =   870
   ClientWidth     =   12075
   ...
   End
End
Attribute VB_Name = "frmRUpdMeetingRpt"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("Update Meeting Criteria", Me) Then Exit Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "Employee Update Meeting Report(s) generated successfully.", vbOKOnly + vbInformation, "Update Meeting Report"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "Update Meeting Report"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating Update Meeting Report.", vbOKOnly + vbCritical, "Update Meeting Report"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "Update Meeting Report", "Select")
    Cri_SetAll = False
...
'        MsgBox "Invalid Update Meeting From Date"
'        dlpReviewFrom.SetFocus
'        Exit Function
'    End If
'    If Not IsDate(dlpReviewTo.Text) Then
'        MsgBox "Invalid Update Meeting To Date"
...
'            MsgBox "Update Meeting To Date cannot be prior to From Date"
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "Update Meeting Report", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRUpdMeetingRpt = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    SQLQ = "SELECT ED_EMPNBR, ED_FNAME, ED_SURNAME, ED_DEPTNO, ED_DIV, ED_ORG, ED_SFDATE,"
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "Update Meeting Form.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "UD_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(Now, "mmddyy") & ".doc"
                ...
                .ActiveDocument.FormFields("txtDivDept").Result = Get_Division_Name(rsEmp("ED_DIV")) & "/" & GetDeptName(rsEmp("ED_DEPTNO"), "DF_NAME")
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Word Forms", "Update Meeting Report", "Generate Word Form")
