...
Begin VB.Form frmJOBSWFC 
   ...
   Begin TrueOleDBGrid60.TDBGrid vbxTrueGrid 
      Bindings        =   "fxjobswfc.frx":0000
      Height          =   3195
      Left            =   120
      OleObjectBlob   =   "fxjobswfc.frx":0014
      TabIndex        =   0
...
'    Else
        ...
        End If
'    End If
    If Len(glbWFCUserSecList) > 0 Then
...
vbxTrueGrid.Columns(2).Caption = lStr("Position Description")
vbxTrueGrid.Columns(3).Caption = lStr("Position Alternate")
vbxTrueGrid.Columns(4).Caption = lStr("Division")
vbxTrueGrid.Columns(6).Caption = lStr("Position Group")
...
Dim SQLQ As String
        ...
        If chkHideInactive Then
            ...
            End If
        End If
        If Len(clpCode(0).Text) > 0 Then 'Ticket #29552 Franks 12/14/2016
            SQLQ = SQLQ & "AND JB_SECTION = '" & clpCode(0).Text & "' "
        End If
        If Len(glbWFCUserSecList) > 0 Then
            SQLQ = SQLQ & " AND JB_SECTION IN " & glbWFCUserSecList & " "
        End If
...
Else
    ...
    If IsNull(Data1.Recordset("JB_SECTION")) Then
        glbJobSection = ""
    Else
        glbJobSection = Data1.Recordset("JB_SECTION")
    End If
