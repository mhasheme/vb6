...
Begin VB.Form frmRTurnovrRt 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   Caption         =   "Turnover Rates Report"
   ClientHeight    =   8715
   ClientLeft      =   570
   ClientTop       =   1095
   ClientWidth     =   10335
   ...
   Begin VB.Frame scrFrame 
      ...
      Begin VB.ComboBox cmbDateBased 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "fzTrnoRt.frx":0000
         Left            =   2280
         List            =   "fzTrnoRt.frx":0002
         Style           =   2  'Dropdown List
         TabIndex        =   13
      ...
      Begin VB.Label Label4 
         ...
         Width           =   1710
      End
      Begin VB.Label lblVolTermType 
         Appearance      =   0  'Flat
         AutoSize        =   -1  'True
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "Voluntary Separation"
         ForeColor       =   &H80000008&
         Height          =   195
         Left            =   120
         TabIndex        =   31
      ...
      Begin VB.Label Label6 
         ...
         Width           =   1530
      End
      Begin VB.Label lblInvTermType 
         Appearance      =   0  'Flat
         AutoSize        =   -1  'True
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "Involuntary Separation"
         ForeColor       =   &H80000008&
         Height          =   195
         Left            =   120
         TabIndex        =   29
   ...
   End
End
Attribute VB_Name = "frmRTurnovrRt"
...
If comGroup(0) <> "(none)" Then
    strRName$ = glbIHRREPORTS & "rzTrnoR1.rpt"
Else
    strRName$ = glbIHRREPORTS & "rzTrnoRt.rpt"
End If
