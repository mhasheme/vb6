...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("IT Hire Form Criteria", Me) Then Exit Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "IT Hire form(s) generated successfully.", vbOKOnly + vbInformation, "IT Hire Form"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "IT Hire Form"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating IT Hire form.", vbOKOnly + vbCritical, "IT Hire Form"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "IT Hire Form", "Select")
    Cri_SetAll = False
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "IT Hire Form", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRITHire = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    SQLQ = "SELECT ED_EMPNBR, ED_FNAME, ED_SURNAME, ED_MIDNAME, ED_DEPTNO, ED_DIV, ED_ORG, ED_ADDR1, ED_ADDR2, "
    SQLQ = SQLQ & " ED_CITY, ED_PROV, ED_PCODE, ED_PHONE, JH_JOB, JH_SDATE, JH_REPTAU FROM HREMP, HR_JOB_HISTORY "
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "IT Hire Form.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "ITHF_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
                ...
                If Not IsNull(rsEmp("JH_REPTAU")) Then
                    strReptAuth1 = GetEmpData(rsEmp("JH_REPTAU"), "ED_FNAME") & " " & GetEmpData(rsEmp("JH_REPTAU"), "ED_SURNAME")
                Else
                    strReptAuth1 = ""
                End If
                .ActiveDocument.FormFields("txtSurname").Result = rsEmp("ED_SURNAME")
                .ActiveDocument.FormFields("txtFirstName").Result = rsEmp("ED_FNAME")
                .ActiveDocument.FormFields("txtMidName").Result = IIf(IsNull(rsEmp("ED_MIDNAME")), "", rsEmp("ED_MIDNAME"))
                .ActiveDocument.FormFields("txtReptAuth1").Result = strReptAuth1
                .ActiveDocument.FormFields("txtShift").Result = GetTABLDesc("EDOR", rsEmp("ED_ORG"))
                ...
                .ActiveDocument.FormFields("dtStartDate").Result = Format(rsEmp("JH_SDATE"), "MMMM d, yyyy")
                .ActiveDocument.FormFields("txtReptAuth1a").Result = strReptAuth1
                .ActiveDocument.FormFields("txtAddress1").Result = rsEmp("ED_ADDR1")
                .ActiveDocument.FormFields("txtAddress2").Result = IIf(IsNull(rsEmp("ED_ADDR2")), "", rsEmp("ED_ADDR2"))
                .ActiveDocument.FormFields("txtCity").Result = rsEmp("ED_CITY")
                .ActiveDocument.FormFields("txtProvince").Result = Get_Province_Name(rsEmp("ED_PROV"))
                .ActiveDocument.FormFields("txtPostalCode").Result = Left(rsEmp("ED_PCODE"), 3) & " " & Mid(rsEmp("ED_PCODE"), 4)
                .ActiveDocument.FormFields("txtTelephone").Result = Format(rsEmp("ED_PHONE"), "###-###-####")
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "IT Hire Form", "IT Hire Form", "Generate Word Form")
