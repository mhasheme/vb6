...
Begin VB.Form frmRTerminationHRRpt 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   Caption         =   "Termination HR Acct Report"
   ClientHeight    =   10950
   ClientLeft      =   435
   ClientTop       =   870
   ClientWidth     =   12060
   ...
   Begin Threed.SSPanel panWindow 
      ...
      Begin VB.PictureBox panDetails 
         ...
         Begin VB.CheckBox chkDismisal 
            ...
            Width           =   1155
         End
         Begin VB.CheckBox chkResignation 
            Caption         =   "Resignation"
            Height          =   195
            Left            =   2400
            TabIndex        =   19
         ...
         Begin INFOHR_Controls.CodeLookup clpCode 
            ...
            Left            =   2100
            TabIndex        =   23
            Tag             =   "00-Enter Reason for Termination"
            Top             =   5640
            Width           =   4005
            _ExtentX        =   7064
            _ExtentY        =   503
   ...
   End
End
Attribute VB_Name = "frmRTerminationHRRpt"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("Termination HR Acct Report Criteria", Me) Then Exit Sub
...
On Error GoTo Error_Dir
    If Dir1.Visible = True Then
        ...
        Dir1.Visible = False
        cmdLocation.Left = 6540     '71400
    Else
        cmdLocation.Caption = "<"
        Drive1.Visible = True
        Dir1.Visible = True
        cmdLocation.Left = 9600 '10200
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "Termination HR Acct Report(s) generated successfully.", vbOKOnly + vbInformation, "Termination HR Acct Report"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "Termination HR Acct Report"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating Termination HR Acct Report.", vbOKOnly + vbCritical, "Termination HR Acct Report"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "Termination HR Acct Report", "Select")
    Cri_SetAll = False
...
Private Function CriCheck()
    ...
    If Len(Trim(clpCode(3).Text)) = 0 Then
        MsgBox "Reason for Termination cannot be blank"
        clpCode(3).SetFocus
        Exit Function
    End If
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "Termination HR Acct Report", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRTerminationHRRpt = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    SQLQ = "SELECT ED_EMPNBR, ED_FNAME, ED_SURNAME, ED_DEPTNO, ED_DIV, ED_ORG, ED_SIN, "
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "Termination HR Acct.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "TR_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
                ...
                .ActiveDocument.FormFields("txtSINSSN").Result = rsEmp("ED_SIN")
                ...
                If chkResignation Then
                    .ActiveDocument.FormFields("chkResignation").CheckBox.Value = True
                End If
                If chkDismisal Then
                    .ActiveDocument.FormFields("chkDismisal").CheckBox.Value = True
                End If
                If chkOther Then
                    .ActiveDocument.FormFields("chkOther").CheckBox.Value = True
                    .ActiveDocument.FormFields("txtOther").Result = txtOther.Text
                End If
                .ActiveDocument.FormFields("txtTermReason").Result = GetTABLDesc("TERM", (clpCode(3).Text))
                
                '.Selection.FormFields.Add Range:=Selection.Range, Type:=.wdFieldType1.wdFieldFormCheckBox
                '.Selection.TypeText Text:=" Check1"
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Word Forms", "Termination Report", "Generate Word Form")
