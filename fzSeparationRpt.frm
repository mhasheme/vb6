...
Begin VB.Form frmRSeparationRpt 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   Caption         =   "Separation HR Acct Report"
   ClientHeight    =   10950
   ClientLeft      =   435
   ClientTop       =   870
   ClientWidth     =   11400
   ...
   Begin Threed.SSPanel panWindow 
      ...
      Begin VB.PictureBox panDetails 
         ...
         Begin INFOHR_Controls.CodeLookup clpCode 
            ...
            Left            =   2100
            TabIndex        =   21
            Tag             =   "00-Enter Reason for Separation"
            Top             =   5640
            Width           =   4005
            _ExtentX        =   7064
            _ExtentY        =   503
   ...
   End
End
Attribute VB_Name = "frmRSeparationRpt"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("Separation Report Criteria", Me) Then Exit Sub
...
Private Sub clpCode_GotFocus(Index As Integer)
    If Index = 3 Then   'Reason for Separation
        clpCode(Index).TransDiv = GetTransDiv()
    End If
End Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "Separation Report(s) generated successfully.", vbOKOnly + vbInformation, "Separation Report"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "Separation Report"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating Separation Report.", vbOKOnly + vbCritical, "Separation Report"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "Separation Report", "Select")
    Cri_SetAll = False
...
Private Function CriCheck()
    ...
    If Len(Trim(clpCode(3).Text)) = 0 Then
        MsgBox "Reason for Separation cannot be blank"
        clpCode(3).SetFocus
        Exit Function
    End If
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "Separation Report", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRSeparationRpt = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    Dim wdFieldType1 As WdFieldType
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "SEPARATION HR Acct.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "SR_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
                ...
                If chkLOA Then
                    .ActiveDocument.FormFields("chkLOA").CheckBox.Value = True
                End If
                If chkLayoff Then
                    .ActiveDocument.FormFields("chkLayOff").CheckBox.Value = True
                End If
                .ActiveDocument.FormFields("txtSeptReason").Result = GetTABLDesc("EDEM", (clpCode(3).Text))
...
Err_Word_Forms:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Word Forms", "Separation Report", "Generate Word Form")
...
Dim xLOA As String
    ...
    SQLQ = SQLQ & "WHERE TB_NAME ='EDEM' AND TB_USR3=1 ORDER BY TB_DESC"
    rsTran.Open SQLQ, gdbAdoIhr001, adOpenStatic
    Do While Not rsTran.EOF
        xLOA = xLOA & ",'" & rsTran("TB_KEY") & "'"
        rsTran.MoveNext
    Loop
    GetTransDiv = xLOA
End Function
