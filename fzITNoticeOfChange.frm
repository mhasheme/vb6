...
Begin VB.Form frmRITNoticeOfChange 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   Caption         =   "IT Notice of Change"
   ClientHeight    =   10950
   ClientLeft      =   435
   ClientTop       =   870
   ClientWidth     =   12990
   ...
   End
End
Attribute VB_Name = "frmRITNoticeOfChange"
...
Public Sub cmdPrint_Click()
    ...
    If CriCheck() Then
        If Not PrtForm("IT Notice of Change Criteria", Me) Then Exit Sub
...
Private Function Cri_SetAll()
    ...
    If intGenForm > 0 Then
        ...
        MsgBox "IT Notice of Change form(s) generated successfully.", vbOKOnly + vbInformation, "IT Notice of Change Form"
    ElseIf intGenForm = 0 Then
        'Employees not found
        MsgBox "No Employees in this selection criteria.", vbOKOnly + vbInformation, "IT Notice of Change Form"
    Else
        'Form generation was unsuccessful
        MsgBox "Problem generating IT Notice of Change form.", vbOKOnly + vbCritical, "IT Notice of Change Form"
    End If
...
modSetCriteria_Err:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Select Report Criteria", "IT Notice of Change Form", "Select")
    Cri_SetAll = False
...
EH:
    ...
    Call ERR_Hndlr(glbErrNum&, glbFrmCaption$, "Form Resize", "IT Notice of Change Form", "Form Resize")
    Resume exH
End Sub

Private Sub Form_Unload(Cancel As Integer)
    MDIMain.panHelp(0).Caption = "Select function from the menu."
    Set frmRITNoticeOfChange = Nothing  'carmen apr 2000
End Sub
...
Private Function Generate_Word_Forms()
    ...
    xlsFileTmpl = glbIHRREPORTS & IIf(Right(glbIHRREPORTS, 1) = "\", "", "\") & "IT Notice of Change Form.dot"
    ...
    If Not rsEmp.EOF Then
        ...
        Do While Not rsEmp.EOF
            ...
            With wdApp
                ...
                xlsFileMat = txtFilePath.Text & IIf(Right(txtFilePath.Text, 1) = "\", "", "\") & "ITNCF_" & rsEmp("ED_SURNAME") & "_" & rsEmp("ED_FNAME") & "_" & Format(dlpAsOf.Text, "mmddyy") & ".doc"
